    ...
    <div class="row">        
        ...
        <div class="input-group collapse" id="collapse-filters">
            ...
            <div class="input-group-append">
                <button class="btn btn-warning" type="button" id="btn_busca">
...
<script>
    ...
    $(document).on('click','.Salvar',function(){
        ...
        var id = $('#id').val();
        if(id == '') return createData('<?=ROTA_GERAL?>/Produto/salvarProdutos', new FormData(document.getElementById("form"))).then( (response) => {
