 <!-- Services-->
 <section class="content-section bg-primary text-white text-center"  style="background-color: <?=$this->color[0]['color']?> !important; color: <?=$this->color[3]['color']?> !important; " id="services">
            <div class="container px-4 px-lg-5">
                ...
                <div class="row gx-4 gx-lg-5">
                    <div class="col-lg-3 col-md-6 mb-5 mb-lg-0">
                        ...
                        <p class="text-faded mb-0" style="color: <?=$this->color[3]['color']?> !important; ">
                            Acesso ao
                    ...
                    <div class="col-lg-3 col-md-6 mb-5 mb-lg-0">
                        ...
                        <p class="text-faded mb-0" style="color: <?=$this->color[3]['color']?> !important; ">apartamentos climatizados.</p>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <p class="text-faded mb-0" style="color: <?=$this->color[3]['color']?> !important; ">sua satifação é nossa alegria!</p>
                    </div>
                </div>
            </div>
        </section>
